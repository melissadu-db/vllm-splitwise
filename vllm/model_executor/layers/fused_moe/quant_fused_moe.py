...
#     qweights2 = qweights2.permute(0, 2, 1)
...
#     intermediate_cache3 = torch.empty((M, topk_ids.shape[1], qweights2.shape[1]),
#                                       device=hidden_states.device,
#                                       dtype=hidden_states.dtype)
